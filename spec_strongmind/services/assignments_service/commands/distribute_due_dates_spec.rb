  ...
  describe "#call" do
    ...
    it 'distributes the assignments across workdays' do
      expect(assignment).to(
        receive(:update).with(due_at: Time.parse('2018-11-27 23:59:59.999999999'))
      )
      ...
      expect(assignment4).to(
        receive(:update).with(due_at: Time.parse('2018-11-28 23:59:59.999999999'))
      )
      subject.call
    end
    ...
    context 'Has less assignments than days' do
      ...
      it 'assigns the last assignment on the last day' do
        ...
        expect(assignment10).to(receive(:update)).with(due_at: Time.parse('2019-11-29 23:59:59.999999999'))
        dates = subject.call
